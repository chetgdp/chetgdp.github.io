...
export function get_header_html() {
    ...
    let deferred1_1;
    try {
        const ret = wasm.get_header_html();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {string}
 */
export function get_footer_html() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.get_footer_html();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function get_about_html() {
    let deferred1_0;
    let deferred1_1;
    try {
...
export const SortOrder = Object.freeze({
    Alphabetical: 0, "0": "Alphabetical",
    DateNewest: 1, "1": "DateNewest",
    DateOldest: 2, "2": "DateOldest",
});
